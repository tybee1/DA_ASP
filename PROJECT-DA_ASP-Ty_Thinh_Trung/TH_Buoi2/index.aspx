                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    ...
                                    <a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">Quit view
                              
                                        <%-- <asp:Button ID="Button1" runat="server" Text="Quit view" />--%>
                            </a>
                                </div>
                        ...
                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                            ...
                            <div class="p-t-33">
                                <div class="flex-w flex-r-m p-b-10">
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <asp:ListBox ID="ListBox1" runat="server" class="js-select2" name="time" />
                                            </asp:ListBox>
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <asp:ListBox ID="ListBox2" runat="server" class="js-select2" name="time" />
                                            </asp:ListBox>
