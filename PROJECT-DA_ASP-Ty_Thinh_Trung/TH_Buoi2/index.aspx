<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TH_Buoi2.index" %>
    ...
    <section class="bg0 p-t-23 p-b-140">
        <div class="container">
            ...
            <div class="flex-w flex-sb-m p-b-52">
                ...
                <asp:DropDownList ID="ddlTimKiem" runat="server" CssClass="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn3 trans-04 m-r-8 m-tb-4" OnSelectedIndexChanged="ddlTimKiem_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        <asp:Label ID="lblTenSP" runat="server" Text='<%# Eval("TENSP") %>'></asp:Label></h4>
                                    </a>
                                    ...
                                    <div class="col-md-6 col-lg-5 p-b-30">
                                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                                            ...
                                            <span class="mtext-106 cl2">
                                                <asp:Label ID="Label1" runat="server" Text="57.87"></asp:Label>
                                            </span>
                                            ...
                                            <div class="p-t-33">
                                                <div class="flex-w flex-r-m p-b-10">
                                                    ...
                                                    <div class="size-204 respon6-next">
                                                        <div class="rs1-select2 bor8 bg0">
                                                            <%--  <asp:DropDownList ID="ddlKichCo" runat="server" ></asp:DropDownList> --%>
                                                ...
                                                <div class="flex-w flex-r-m p-b-10">
                                                    <div class="size-204 flex-w flex-m respon6-next">
                                                        ...
                                                        <asp:Button ID="btnAddToCart" runat="server" Text="Add to cart" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" />
